...
resourcestring
  ...
  S_WRONG_SETTINGS = 'Start database not found. Please check path Options menu.';
  ...
  S_COPYRIGHT = 'EAAD Editor (C) 2015 Uto';
  ...
  S_BROWSER_NOT_FOUND = 'Browser not found.';
  ...
  S_INVALID_FORMAT = 'Not a valid SCE file';
  ...
  S_ACTIONS = 'Choose an action...'#13#10'Object <....> appears'#13#10'Object <....> disappears'#13#10'Object <....> appears at location <....>'#13#10'Flag <....> is increased by <....>'#13#10'Flag <....> is decreased by <....>'#13#10'Flag <....> value is set to <....>';
  ...
  S_OBJECT = 'Object';
  S_OBJECT_HINT = 'Please enter number or #define label value for an object';
  S_FLAG = 'Flag';
  S_FLAG_HINT = 'Please enter number or #define label for a flag';
  S_LOCATION = 'Location';
  S_LOCATIONS_HINT = 'Please enter number or #define label for a location';
  S_VALUE = 'Value';
