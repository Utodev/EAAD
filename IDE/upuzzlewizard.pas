...
type
  ...
  private
    ...
    function getMessNumber(messageText: String): String;
  public
...
begin
  ...
  // Create the wrong location failure entry
...
function TfPuzzleWizard.getMessNumber(messageText: String): String;
begin
   Result := 'X';
end;
